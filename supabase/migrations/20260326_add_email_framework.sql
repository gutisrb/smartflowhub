-- Add email_framework to contacts and kontakti view
...
--   UPDATE/INSERT triggers now propagate email_framework

ALTER TABLE "public"."contacts" 
ADD COLUMN IF NOT EXISTS "email_framework" text DEFAULT '3-sentence';
...
BEGIN
    ...
    INSERT INTO contacts (
        ...
        COALESCE(NEW.intake_nudge_poslat, false), COALESCE(NEW.email_framework, '3-sentence')
    );
